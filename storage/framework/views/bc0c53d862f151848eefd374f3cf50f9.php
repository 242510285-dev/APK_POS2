...
<?php $__env->startSection('content'); ?>
    ...
    <style>
        ...
        /* PERBAIKAN WARNA LABEL */
        .form-label.text-slate-300 {
        ...
        /* PERBAIKAN WARNA Rp */
        .input-group-text.text-slate-400 {
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-lg-7">
                        ...
                        <div class="mb-3">
                            ...
                            <label class="form-label fw-bold text-slate-300 small">
                                Nama Produk
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-6 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text border-0 text-slate-400"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div
                            class="d-flex gap-2 justify-content-end mt-4 pt-3 border-top border-secondary border-opacity-10">

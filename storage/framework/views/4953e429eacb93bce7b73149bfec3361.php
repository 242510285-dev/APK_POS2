    ...
    <div class="container py-5">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                ...
                <p class="text-slate-400 mb-0 small" style="color: #94a3b8;">Kelola informasi stok, harga beli, dan harga jual
                    barang.</p>
            </div>
            <div>
                <a href="<?php echo e(route('produk.create')); ?>" class="btn btn-create-pro d-inline-flex align-items-center gap-2">
            ...
            <div class="col-12 col-md-6 col-lg-5">
                <form action="<?php echo e(route('produk.index')); ?>" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control input-search-dark"
                    ...
                    <tbody>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $dataProduk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="font-monospace" style="color: #cbd5e1;">
                                    Rp <?php echo e(number_format($item->harga_beli ?? 0, 0, ',', '.')); ?>

                                </td>
                                <td class="fw-bold font-monospace" style="color: #34d399;">
                                ...
                                <td class="text-center">
                                    <?php if(($item->stok ?? 0) <= 0): ?>
                                        <span class="badge px-3 py-1.5 rounded-pill fw-bold"
                                            style="background: rgba(239, 68, 68, 0.2); color: #f87171;">Habis</span>
                                    <?php elseif(($item->stok ?? 0) <= 5): ?>
                                        <span class="badge px-3 py-1.5 rounded-pill fw-bold"
                                            style="background: rgba(245, 158, 11, 0.2); color: #fbbf24;"><?php echo e($item->stok); ?></span>
                                    <?php else: ?>
                                        <span class="badge px-3 py-1.5 rounded-pill fw-bold"
                                            style="background: rgba(16, 185, 129, 0.2); color: #34d399;"><?php echo e($item->stok); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="<?php echo e(route('produk.show', $item->id)); ?>"
                                            class="btn btn-action btn-action-info" title="Detail">
                                            <i class="bi bi-eye-fill"></i> Detail
                                        </a>
                                        <a href="<?php echo e(route('produk.edit', $item->id)); ?>"
                                            class="btn btn-action btn-action-warning" title="Edit">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="8" class="text-center py-5" style="color: #94a3b8;">
                                    <i class="bi bi-inbox fs-1 d-block mb-2" style="color: #475569;"></i>

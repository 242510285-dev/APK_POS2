            ...
            <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                <div class="dropdown">
                    <button class="btn user-pill d-flex align-items-center gap-2 dropdown-toggle" type="button"
                        ...
                        <span class="fw-semibold small text-white"><?php echo e(Auth::user()->name ?? 'kuda'); ?></span>
                    </button>
...
<?php /**PATH C:\laragon\www\APK_POS1-main\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>